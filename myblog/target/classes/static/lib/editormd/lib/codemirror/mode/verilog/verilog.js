...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "bins binsof bit break buf bufif0 bufif1 byte case casex casez cell chandle checker class clocking cmos com.config " +
  ...
  */
  ...
  var blockKeywords = words(
    "case checker class clocking com.config function generate interface module package" +
